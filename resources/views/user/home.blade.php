...
@section('title', 'BrainBoost Home Page')
                    ...
                    <div class="row g-3">
                        <div class="col-lg-12 col-md-12 wow zoomIn" data-wow-delay="0.1s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid"
                                    src="{{ asset('user/img/Cacti & Succulents Store Web site Concept.jpg') }}"
                                    alt="">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.3s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="{{ asset('user/img/GraphicDesign1.jpg') }}" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                    style="margin: 1px;">
                        ...
                        <div class="col-lg-6 col-md-12 wow zoomIn" data-wow-delay="0.5s">
                            <a class="position-relative d-block overflow-hidden" href="">
                                <img class="img-fluid" src="{{ asset('user/img/videoedit.jpg') }}" alt="">
                                <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                                    style="margin: 1px;">
                ...
                <div class="col-lg-5 col-md-6 wow zoomIn" data-wow-delay="0.7s" style="min-height: 350px;">
                    <a class="position-relative d-block h-100 overflow-hidden" href="">
                        <img class="img-fluid position-absolute w-100 h-100"
                            src="{{ asset('user/img/DigitalMarketing.jpg') }}" alt="" style="object-fit: cover;">
                        <div class="bg-white text-center position-absolute bottom-0 end-0 py-2 px-3"
                            style="margin:  1px;">
            ...
            <div class="row g-4 justify-content-center">
                @if (count($courses) != 0)
                    @foreach ($courses as $index => $course)
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.{{ 2 * $index + 1 }}s">
                            <div class="course-item bg-light">
                                <div class="position-relative overflow-hidden">
                                    <img class="img-fluid" src="{{ asset('course/' . $course->image) }}" alt=""
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('course#join', $course->id) }}"
                                ...
                                <div class="d-flex border-top">
                                    ...
                                    <small class="flex-fill text-center py-2"><i
                                            class="fa fa-user text-primary me-2"></i>{{ $course->student_count }}
                                        Students</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.{{ 1 * $index + 1 }}s">
                            <div class="team-item bg-light">
                                <div class="overflow-hidden">
                                    <img class="img-fluid mx-auto d-flex justify-content-center"
                                        src="{{ asset($instructor->profile ? 'profilePhoto/' . $instructor->profile : 'defaultProfile/profile.png') }}"
